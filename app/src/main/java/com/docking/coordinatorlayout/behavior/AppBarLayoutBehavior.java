 ...
 * from: https://www.jianshu.com/p/507091d4cc0f
 */
public class AppBarLayoutBehavior extends AppBarLayout.Behavior {
    ...
    private boolean enableNestedScroll = true;
    ...
    public boolean isEnableNestedScroll() {
        return enableNestedScroll;
    }

    public void setEnableNestedScroll(boolean flag) {
        this.enableNestedScroll = flag;
    }
    ...
    public boolean onStartNestedScroll(CoordinatorLayout parent, AppBarLayout child,
        ...
        LogUtil.d("dkk", TAG + " onStartNestedScroll");
        stopAppbarLayoutFling(child);
    ...
    public void onNestedPreScroll(CoordinatorLayout coordinatorLayout,
        ...
        LogUtil.d("dkk", TAG + " onNestedPreScroll:" + child.getTotalScrollRange()
